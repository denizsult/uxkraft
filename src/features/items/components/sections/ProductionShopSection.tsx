...
export const ProductionShopSection = ({
  ...
  const markup = ((item.price - unitPrice) / unitPrice) * 100;
        ...
        <CardContent className="flex flex-col items-start gap-5 p-5">
          <div className="grid grid-cols-3 grid-rows-3 h-[258px] gap-3 w-full max-w-[528px]">
            {infoFields.map((field, index) => (
              ...
              >
                <div className="w-[130px] font-medium text-[#616161] text-xs  leading-5">
                  {field.label}
                </div>
                <div className="flex items-center gap-1 w-full">
                  <div className="flex flex-col items-start justify-center flex-1">
                    ...
                    {field.subValue && (
                      <div className="flex items-center justify-center w-full h-4 font-normal text-[#616161] text-xs tracking-[0] leading-4 whitespace-nowrap">
                        {field.subValue}
                      </div>
                    )}
                  </div>
            ...
            <div className="row-[3_/_4] col-[3_/_4] w-full h-fit flex flex-col items-start gap-2">
              <div className="font-medium text-[#616161] text-xs  leading-5 w-full">
                Upload
              </div>
          ...
          <div className="flex flex-col items-start gap-3 w-full">
            <div className="flex flex-col items-start w-full bg-white rounded-sm border border-solid border-[#d8d8d8]">
              <div className="flex items-start w-full bg-[#f6f3f3] rounded-[2px_2px_0px_0px] border-b border-solid border-[#d8d8d8]">
                {tableHeaders.map((header, index) => (
                  ...
                  >
                    <div className="w-full font-medium text-[#616161] text-xs tracking-[0] leading-5">
                      {header.label}
                    </div>
                  </div>
                ))}
            ...
            <div className="flex h-8 items-center justify-end gap-3 px-3 py-0 w-full bg-[#fcfcfc] rounded">
